...
const ProductDetails = () => {
  ...
  const fetchProducts = async () => {
    try {
      ...
      const resp = await axios.get(`https://e2e-backend-dmsf.onrender.com/api/v1/products/${id}`, {
        headers: {
    ...
    <div className="container mx-auto p-4">
      {singleProduct ? (
        <div className="flex singleProducts-center justify-between gap-8">
          ...
          <div className="w-1/2">
            <img
              src={singleProduct.imgSrc ? `https://e2e-backend-dmsf.onrender.com/images/${singleProduct.imgSrc}` :`${singleProduct.imgSrc}`}
