  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
     ...
     // passing the optiond to post  api
      const res = await axios.post("https://e2e-backend-lkud.onrender.com/api/v1/payment/createOrder", options);
      const data = res.data;
      ...
      const paymentObject = new window.Razorpay({
        ...
        handler: async function (response) { //getting response of above api and  allocation varaible to reqired feilds
          ...
          const res = await axios.post(
            "https://e2e-backend-lkud.onrender.com/api/v1/payment/verifyOrder",
            options2,
            {
              headers: {
